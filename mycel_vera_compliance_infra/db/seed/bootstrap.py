...
PERMISSIONS = [
    ("read", "entities", "Read entities records"),
    ("write", "entities", "Create/update/delete entities records"),
]

ROLES = {
    "mycel_vera_compliance_reader": {
        "description": "Read-only access to mycel_vera_compliance data",
        "filter": lambda a, r: a == "read",
    },
    "mycel_vera_compliance_writer": {
        "description": "Full CRUD access to mycel_vera_compliance data",
...
async def seed_rbac():
    ...
    print(f"  RBAC seed complete for mycel_vera_compliance")


if __name__ == "__main__":
    print(f"\n=== RBAC Bootstrap: mycel_vera_compliance ===")
